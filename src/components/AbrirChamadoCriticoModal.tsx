...
export default function AbrirChamadoCriticoModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-lg shadow-2xl w-[95%] h-[90vh] max-w-6xl flex flex-col z-50">
        {/* Header com aviso crítico */}
        <div className="flex items-center justify-between p-6 border-b border-red-200 bg-red-50 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-red-900">Abrir Chamado Crítico</h2>
        ...
        {/* Aviso importante */}
        <div className="bg-yellow-50 border-b border-yellow-200 p-4 flex-shrink-0">
