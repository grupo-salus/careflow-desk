    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-2xl w-[95%] h-[90vh] max-w-6xl flex flex-col z-50">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 flex-shrink-0">
          <h2 className="text-2xl font-bold text-gray-900">Abrir Novo Chamado</h2>
          <button
            onClick={handleClose}
                ...
                {motivosFiltrados.map((motivo) => (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-lg border-2 transition-all ${
                      motivoSelecionado?.id === motivo.id
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <h3 className="font-semibold text-gray-900 mb-1">{motivo.titulo}</h3>
                        <p className="text-sm text-gray-600 mb-2">{motivo.descricao}</p>
